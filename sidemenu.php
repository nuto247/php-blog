    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        ...
        <?php if (!empty($user['avatar'])) { ?>
          ...
          <img src="<?php echo 'uploads/' . $user['avatar'];  ?>" class="img-circle elevation-2" alt="User Image">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="blog-manage-posts.php" class="nav-link">
                <i class="nav-icon fas fa-th"></i>
                <p>
                  Manage Post
                </p>
            ...
            <li class="nav-item">
              <a href="blog-add-post.php" class="nav-link">
                <i class="nav-icon fas fa-th"></i>
                <p>
                  Add Post
                </p>
